...
-- Appetizers
('Ramen Appetizer Bowl', 150.00, 280.00, 'Appetizer', 50, NULL),
('Miso Soup Shot', 45.00, 95.00, 'Appetizer', 100, @vegetarian_id),
('Edamame (Steamed Soybeans)', 60.00, 120.00, 'Appetizer', 80, @vegan_id),
('Takoyaki (Octopus Balls)', 180.00, 320.00, 'Appetizer', 40, @pescatarian_id),
('Gyoza (Dumplings)', 120.00, 240.00, 'Appetizer', 60, NULL),
('Tempura Shrimp', 200.00, 380.00, 'Appetizer', 35, @pescatarian_id),
('Vegetable Spring Rolls', 90.00, 170.00, 'Appetizer', 70, @vegan_id),
('Chicken Yakitori', 140.00, 260.00, 'Appetizer', 45, @no_pork_id),
('Tofu Skewers', 100.00, 190.00, 'Appetizer', 55, @vegan_id),
('Seaweed Salad', 70.00, 140.00, 'Appetizer', 65, @vegan_id),

-- Main Courses
('Ichiraku Ramen Special', 350.00, 650.00, 'Main Course', 30, NULL),
('Naruto Udon Bowl', 280.00, 520.00, 'Main Course', 35, @vegetarian_id),
('Sasuke Teriyaki Chicken', 420.00, 780.00, 'Main Course', 25, @no_pork_id),
('Sakura Sushi Platter', 550.00, 980.00, 'Main Course', 20, @pescatarian_id),
('Kakashi Grilled Fish', 380.00, 720.00, 'Main Course', 22, @pescatarian_id),
('Beef Sukiyaki', 450.00, 850.00, 'Main Course', 20, @no_pork_id),
('Vegetarian Curry Bowl', 320.00, 600.00, 'Main Course', 30, @vegan_id),
('Tofu Teriyaki Bowl', 280.00, 520.00, 'Main Course', 35, @vegan_id),
('Chicken Katsu Curry', 400.00, 750.00, 'Main Course', 28, @no_pork_id),
('Salmon Teriyaki', 390.00, 730.00, 'Main Course', 24, @pescatarian_id),

-- Beverages
('Green Tea', 25.00, 50.00, 'Beverage', 200, @vegan_id),
('Matcha Latte', 45.00, 90.00, 'Beverage', 150, @vegetarian_id),
('Japanese Iced Coffee', 40.00, 80.00, 'Beverage', 120, @vegan_id),
('Sake (Premium)', 120.00, 240.00, 'Beverage', 80, NULL),
('Plum Wine', 100.00, 200.00, 'Beverage', 70, NULL),
('Fresh Orange Juice', 35.00, 70.00, 'Beverage', 180, @vegan_id),
('Mango Smoothie', 50.00, 100.00, 'Beverage', 140, @vegetarian_id),
('Sparkling Water', 20.00, 40.00, 'Beverage', 250, @vegan_id),
('Yuzu Lemonade', 40.00, 80.00, 'Beverage', 160, @vegan_id),
('Hot Sake', 110.00, 220.00, 'Beverage', 90, NULL),

-- Desserts
('Dango Trio (Sweet Rice Balls)', 90.00, 180.00, 'Dessert', 70, @vegan_id),
('Mochi Ice Cream', 110.00, 220.00, 'Dessert', 65, @vegetarian_id),
('Matcha Green Tea Cake', 140.00, 280.00, 'Dessert', 40, @vegetarian_id),
('Red Bean Mochi', 95.00, 190.00, 'Dessert', 60, @vegan_id),
('Sesame Balls', 85.00, 170.00, 'Dessert', 75, @vegan_id),
('Taiyaki (Fish-shaped Cake)', 80.00, 160.00, 'Dessert', 68, @vegetarian_id),
('Warabimochi', 75.00, 150.00, 'Dessert', 72, @vegan_id),
('Green Tea Ice Cream', 100.00, 200.00, 'Dessert', 58, @vegetarian_id),
('Anmitsu', 120.00, 240.00, 'Dessert', 50, @vegan_id),
('Dorayaki', 85.00, 170.00, 'Dessert', 65, @vegetarian_id);
